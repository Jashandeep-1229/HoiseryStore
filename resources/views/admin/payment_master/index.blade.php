...
@section('content')
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card" id="add_payment_master">
                    <form action="{{route('payment_master.store')}}" method="POST" id="" class="modal-content" enctype="multipart/form-data">
                        @csrf
...
@section('script')
    <script>
        ...
        function delete_payment_master(id){
            swal({
                title: "Are you sure?",
            ...
            .then((willDelete) => {
                if (willDelete) {
                    var url = "{{route('payment_master.delete',":id")}}";
                    url = url.replace(':id',id);
        ...
        function change_status(id){
            var url = "{{route('payment_master.change_status',":id")}}";
            url = url.replace(':id',id);
            $.get(url, function(data){
                if(data.result == 1){
