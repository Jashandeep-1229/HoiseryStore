<div class="row widget-grid">
      ...
      <div class="card small-widget"> 
        <div class="card-body primary"> <span class="f-light">Total Sale</span>
          <div class="d-flex align-items-end gap-1">
            <h4>{{formatIndianNumber($total_sale)}}</h4><span class="font-primary f-12 f-w-500"></span>
          </div>
    ...
    <div class="col-md-2">
      <div class="card small-widget"> 
        <div class="card-body success"> <span class="f-light">Total Purchase</span>
          <div class="d-flex align-items-end gap-1">
            <h4>{{formatIndianNumber($total_purchase)}}</h4><span class="font-success f-12 f-w-500"></span>
          </div>
    ...
    <div class="col-md-2">
      <div class="card small-widget"> 
        <div class="card-body warning"> <span class="f-light">Total Profit</span>
          <div class="d-flex align-items-end gap-1">
            <h4>{{formatIndianNumber($total_profit)}}</h4><span class="font-warning f-12 f-w-500"></span>
          </div>
    ...
    <div class="col-md-2">
      <div class="card small-widget"> 
        <div class="card-body info"> <span class="f-light">Total Expense</span>
          <div class="d-flex align-items-end gap-1">
            <h4>{{formatIndianNumber($totals['expense'] + $totals['payment'])}}</h4><span class="font-info f-12 f-w-500"></span>
          </div>
    ...
    <div class="col-md-2">
      <div class="card small-widget"> 
        <div class="card-body info"> <span class="f-light">Cash In Hand</span>
          <div class="d-flex align-items-end gap-1">
            <h4>{{formatIndianNumber($totals['income'] + $totals['received'])}}</h4><span class="font-info f-12 f-w-500"></span>
          </div>
          <div class="bg-gradient font-info"> 
            <i class="fa fa-inr f-18"></i>
          </div>
    ...
    <div class="col-md-2">
      <div class="card small-widget"> 
        <div class="card-body info"> <span class="f-light">Balance</span>
          <div class="d-flex align-items-end gap-1">
            <h4>{{formatIndianNumber(($totals['income'] + $total_profit + $totals['received']) - ($totals['expense'] + $totals['payment']))}}</h4><span class="font-info f-12 f-w-500"></span>
          </div>
          <div class="bg-gradient font-info"> 
            <i class="fa fa-inr f-18"></i>
          </div>
    ...
    <div class="col-md-2">
      <div class="card small-widget"> 
        <div class="card-body info"> <span class="f-light">Vendor Payment Due</span>
          <div class="d-flex align-items-end gap-1">
            <h4>{{formatIndianNumber(($totalVendor->total_cr) - ($totalVendor->total_dr))}}</h4><span class="font-info f-12 f-w-500"></span>
          </div>
          <div class="bg-gradient font-info"> 
            <i class="fa fa-inr f-18"></i>
          </div>
    ...
    <div class="col-md-2">
      <div class="card small-widget"> 
        <div class="card-body info"> <span class="f-light">Customer Payment Due</span>
          <div class="d-flex align-items-end gap-1">
            <h4>{{formatIndianNumber(($totalCustomer->total_dr) - ($totalCustomer->total_cr))}}</h4><span class="font-info f-12 f-w-500"></span>
          </div>
          <div class="bg-gradient font-info"> 
            <i class="fa fa-inr f-18"></i>
          </div>
