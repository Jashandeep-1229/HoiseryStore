      ...
      <div class="card small-widget"> 
        <div class="card-body primary"> <span class="f-light">Total Expense</span>
          <div class="d-flex align-items-end gap-1">
            <h4>{{formatIndianNumber($totals['expense'] + $totals['payment'])}}</h4><span class="font-primary f-12 f-w-500"></span>
          </div>
    ...
    <div class="col-md-2">
      <div class="card small-widget"> 
        <div class="card-body warning"> <span class="f-light">Total Purchase</span>
          <div class="d-flex align-items-end gap-1">
            <h4>{{formatIndianNumber($totals['purchase'])}}</h4><span class="font-warning f-12 f-w-500"></span>
          </div>
    ...
    <div class="col-md-2">
      <div class="card small-widget"> 
        <div class="card-body info"> <span class="f-light">Total Sale</span>
          <div class="d-flex align-items-end gap-1">
            <h4>{{formatIndianNumber($totals['sale'])}}</h4><span class="font-info f-12 f-w-500"></span>
          </div>
