...
@section('script')
    <script>
        ...
        function get_datatable(page){
            ...
            var page = page ?? 1;
            $.get('{{ route("stock.report.datatable") }}?page='+page+'&value='+value+'&search='+search+'', { _token: "{{csrf_token() }}",from_date:from_date,to_date:to_date}, function(data){
                ...
                $('#basic-test').DataTable({
                    ...
                    buttons: [
                        ...
                        'csv', 
                        {
                            ...
                            title: 'Aasha Fashion - Stock Report' // Optional
                        },
                        'print'
                    ]
                });
