...
@section('breadcrumb-items')
    <li class="breadcrumb-item">All Purchases Report</li>
@endsection
                    ...
                    <div class="card-body">
                        <div  id="basic-2_wrapper" class="dataTables_wrapper px-2 row" onchange="get_datatable()">
                            ...
                            <div class="col-md-3">
                                <div class="dataTables_filter ">
                                    <label>Vendor 
                                        <select name="vendor_id"  id="vendor_id" aria-controls="basic-2" class="form-control form-control-sm">
...
@section('script')
    <script>
        ...
        function get_datatable(page){
            ...
            $.get('{{ route("purchase.datatable") }}?page='+page+'&value='+value+'&search='+search+'', { _token: "{{csrf_token() }}",from_date:from_date,to_date:to_date,vendor_id:vendor_id}, function(data){
